...
public class LoanProductData implements Serializable {
    ...
    public LoanProductData(final Long id, final String name, final String shortName, final String description, final CurrencyData currency,
            ...
            @JsonProperty("inArrearsTolerance") final BigDecimal tolerance, final Integer numberOfRepayments,
            final Integer minNumberOfRepayments, final Integer maxNumberOfRepayments, final Integer repaymentEvery,
            final BigDecimal interestRatePerPeriod, final BigDecimal minInterestRatePerPeriod, final BigDecimal maxInterestRatePerPeriod,
            ...
            @JsonProperty("accountingRule") final EnumOptionData accountingType, final boolean includeInBorrowerCycle,
            boolean useBorrowerCycle, final LocalDate startDate, final LocalDate closeDate, final String status, final String externalId,
            @JsonProperty("principalVariationsForBorrowerCycle") Collection<LoanProductBorrowerCycleVariationData> principalVariations,
            @JsonProperty("interestRateVariationsForBorrowerCycle") Collection<LoanProductBorrowerCycleVariationData> interestRateVariations,
            @JsonProperty("numberOfRepaymentVariationsForBorrowerCycle") Collection<LoanProductBorrowerCycleVariationData> numberOfRepaymentVariations,
            Boolean multiDisburseLoan, Integer maxTrancheCount, BigDecimal outstandingLoanBalance,
            final Boolean disallowExpectedDisbursements, final Boolean allowApprovedDisbursedAmountsOverApplied,
            final String overAppliedCalculationType, final Integer overAppliedNumber, final Boolean allowFullTermForTranche,
            ...
            @JsonProperty("productGuaranteeData") final LoanProductGuaranteeData loanProductGuaranteeData,
            final BigDecimal principalThresholdForLastInstallment, final boolean accountMovesOutOfNPAOnlyOnArrearsCompletion,
            boolean canDefineInstallmentAmount, Integer installmentAmountInMultiplesOf,
            ...
            @JsonProperty("allowVariableInstallments") final boolean isVariableInstallmentsAllowed,
            @JsonProperty("minimumGap") final Integer minimumGapBetweenInstallments,
            @JsonProperty("maximumGap") final Integer maximumGapBetweenInstallments, final boolean syncExpectedWithDisbursementDate,
            final boolean canUseForTopup, final boolean isEqualAmortization, Collection<RateData> rateOptions, Collection<RateData> rates,
            final boolean isRatesEnabled, final BigDecimal fixedPrincipalPercentagePerInstallment,
            final Collection<DelinquencyBucketData> delinquencyBucketOptions, final DelinquencyBucketData delinquencyBucket,
            final Integer dueDaysForRepaymentEvent, final Integer overDueDaysForRepaymentEvent, final boolean enableDownPayment,
