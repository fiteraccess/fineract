...
class AccrualBasedAccountingProcessorForSavingsTest {
    ...
    void shouldRouteSignedStatementFeeToMappedIncomeAccountInAccrualAccountingAB339() {
        ...
        processor.createJournalEntriesForSavings(
                savings(transaction(SavingsAccountTransactionType.SIGNED_STATEMENT_FEE, null, BigDecimal.valueOf(20), null, null)));
    ...
    @Test
    void shouldSplitBillsPostingPrincipalBetweenAggregatorPayableAndCommissionIncomeInAccrualAccounting() {
        GLAccount savingsControl = glAccount(101L);
    ...
    @Test
    void shouldOmitZeroCommissionCreditForBillsPostingPrincipalWithNoCommissionInAccrualAccounting() {
        GLAccount savingsControl = glAccount(101L);
    ...
    private SavingsTransactionDTO transaction(final SavingsAccountTransactionType type, final String switchId, final BigDecimal amount,
        ...
        return new SavingsTransactionDTO(33L, 44L, transactionId, TRANSACTION_DATE, transactionType, amount, false, List.of(), List.of(),
                overdraftAmount, false, List.of(), switchId, null, null, commissionAllocation);
    }
