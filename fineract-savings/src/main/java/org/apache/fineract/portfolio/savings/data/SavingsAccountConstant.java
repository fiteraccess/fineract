...
public class SavingsAccountConstant extends SavingsApiConstants {
    ...
    protected static final Set<String> SAVINGS_ACCOUNT_TRANSACTION_REQUEST_DATA_PARAMETERS = new HashSet<>(
            Arrays.asList(localeParamName, dateFormatParamName, transactionDateParamName, transactionAmountParamName,
                    paymentTypeIdParamName, switchCodeParamName, transactionAccountNumberParamName, checkNumberParamName,
                    routingCodeParamName, receiptNumberParamName, bankNumberParamName, retailEntriesParamName, childAccountIdParamName,
                    noteParamName, amountParamName, dateParamName, isManualTransaction, lienTransaction, chargesPaidByData,
                    submittedOnDateParamName, accountIdParamName, accountNoParamName, referenceTransactionsParamName));
