...
public class AggregatorAccountingConfigurationValidator {

    private final FromJsonHelper fromApiJsonHelper;

    public void validateForUpsert(String aggregatorCode, JsonCommand command) {
        ...
        DataValidatorBuilder validator = new DataValidatorBuilder(errors).resource("aggregatorAccountingConfiguration");
